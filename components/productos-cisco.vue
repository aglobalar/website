    ...
    <div class="container center">
      <div class="flex flex-wrap justify-between items-center">
        <div class="w-50-l w-100 pr4-l ph4 pv5">
         <div class="pv4-l pv0"> <h2 class="about-title blue-gl "><em>DUO</em> está diseñado para proteger a todos los usuarios, dispositivos y
            aplicaciones</h2>

          <p class="lh-global">La autenticación multifactor de Duo protege las aplicaciones mediante el uso de una
            segunda
